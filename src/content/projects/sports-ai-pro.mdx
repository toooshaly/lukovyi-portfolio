...
<figure>
  <img loading="lazy" decoding="async" src="/media/sports/s01-before.webp" alt="The original interface — inconsistent typography, no hierarchy, data-heavy screens" />
...
![Match / prediction screen — v1 to v2 to v3](/media/sports/s05-match.webp)

![Match detail & team stats — v1 to v3](/media/sports/s05-detail.webp)

![Compare odds table — v1 to v2 to v3](/media/sports/s05-oddsfeature.webp)
...
<div class="cs-row">
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-1.webp" alt="App Store screen 1 — AI-powered insights for every sport" />
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-2.webp" alt="App Store screen 2 — build your custom AI model" />
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-3.webp" alt="App Store screen 3 — create your personal Prediction Slip" />
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-4.webp" alt="App Store screen 4 — analyse leagues and teams" />
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-5.webp" alt="App Store screen 5 — explore detailed stats" />
  <img loading="lazy" decoding="async" src="/media/sports/s07-appstore-6.webp" alt="App Store screen 6 — head-to-head stats for smarter picks" />
</div>

<figure>
  <img loading="lazy" decoding="async" src="/media/sports/s07-landing.webp" alt="Landing page — carrying the app's visual language to the web" />
  <figcaption>Landing page — the same visual language, carried to the web.</figcaption>
</figure>

<figure>
  <img loading="lazy" decoding="async" src="/media/sports/s07-paywall-strip.webp" alt="Paywall variants — each leads with the value before asking for payment" />
...
<figure>
  <img loading="lazy" decoding="async" src="/media/sports/s10-workflow.webp" alt="The v3 pipeline — client brief to Claude Code to Claude Design, iterate, into Figma, extract components, publish the system" />
...
![Sports AI-Pro — the v3 experience](/media/sports/s05-cinematic.webp)
...
<div class="cs-row">
  <img loading="lazy" decoding="async" src="/media/sports/s10-depth-2.webp" alt="Match details — v3" />
  <img loading="lazy" decoding="async" src="/media/sports/s10-depth-3.webp" alt="Prediction panel — v3" />
  <img loading="lazy" decoding="async" src="/media/sports/s10-depth-4.webp" alt="New H2H — v3" />
</div>
...
<div class="cs-quad">
  <img loading="lazy" decoding="async" src="/media/sports/s11-ig-1.webp" alt="Social post — Sports AI-Pro" />
  <img loading="lazy" decoding="async" src="/media/sports/s11-ig-2.webp" alt="Social post — Sports AI-Pro" />
  <img loading="lazy" decoding="async" src="/media/sports/s11-ig-3.webp" alt="Social post — Sports AI-Pro" />
  <img loading="lazy" decoding="async" src="/media/sports/s11-ig-4.webp" alt="Social post — Sports AI-Pro" />
</div>
